# ============================================================
# Knowledge Assistant (Mini ChatGPT using RAG)
# ============================================================

# ============================================================
# Project Overview
# ============================================================
# In this task, I built a Knowledge Assistant that can answer
# questions based on uploaded documents.
#
# The system allows users to upload PDF, TXT, and Markdown files.
# It extracts text from the documents and splits it into smaller
...
# relevant chunks and sends them to the OpenAI model.
#
# Finally, the model generates a natural language answer based
# on the retrieved document context.
#
# This approach is based on Retrieval-Augmented Generation (RAG).
# ============================================================
